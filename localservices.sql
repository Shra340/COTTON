...
8  What is the totoal orders and amount spent for each member before they became a member?
...
9  if buying each product genrates points for ex. RS.5=2 zomato point and each product has different purchsing points 
ex. for p1 RS.5=1 zomato point, for p2 RS.10=5 zomato points and p3 RS>5=1 zomato point,
calculate points collected by each customers and for which product most points have been given till now.

select userid,sum(total_points)*2.5 total_mony_earned from
...
10  In the first one year after ac sutomer joins the gold program(including their join date) irrespective of what customer has purchased they earn 5 zomato points
for every RS.10 spent who earned more than 1 or 3 and what was points earings in the 1st year?
...
12 rank all the transactions for each member whenever they are a gold member for every non-gold member transcation mark as na
